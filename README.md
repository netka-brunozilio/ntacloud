...
```bash
/bin/bash -c "$(curl -fsSL https://get.netka.io/ntacloud/install.sh)"
```
...
You can use the following Git Sources to be auto-deployed to your NTACloudt instance! (Self hosted versions also supported.)
...
- Email: [andras@netka.io](mailto:andras@netka.io)
