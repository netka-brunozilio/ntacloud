...
<script lang="ts">
	...
	if (browser && window.location.hostname === 'demo.ntacloud.io' && !application.fqdn) {
		application.fqdn = `http://${cuid()}.demo.ntacloud.io`;
	}
		...
		<div class="grid grid-flow-row gap-2 px-10">
			<div class="grid grid-cols-2">
				<div class="flex-col">
					...
					{#if browser && window.location.hostname === 'demo.ntacloud.io'}
						<Explainer
