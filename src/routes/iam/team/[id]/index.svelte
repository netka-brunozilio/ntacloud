			...
			<div class="mt-2 grid grid-cols-2">
				<div class="flex-col">
					...
					{#if team.id === '0'}
						<Explainer
							customClass="w-full"
							text="This is the <span class='text-red-500 font-bold'>root</span> team. That means members of this group can manage instance wide settings and have all the priviliges in NTACloud (imagine like root user on Linux)."
						/>
					{/if}
				</div>
