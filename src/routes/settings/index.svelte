...
{#if $session.teamId === '0'}
	<div class="mx-auto max-w-4xl px-6">
			...
			<div class="grid grid-flow-row gap-2 px-10">
				<div class="grid grid-cols-2 items-start">
					<div class="flex-col">
						...
						<Explainer
							text="If you specify <span class='text-yellow-500 font-bold'>https</span>, NTACloud will be accessible only over https. SSL certificate will be generated for you.<br>If you specify <span class='text-yellow-500 font-bold'>www</span>, NTACloud will be redirected (302) from non-www and vice versa."
						/>
					</div>
					<div class="justify-start text-left">
						<input
							...
							placeholder="eg: https://ntacloud.io"
						/>
					</div>
				</div>
		...
		<div class="flex space-x-1 pt-6 font-bold">
			<div class="title">NTACloud Proxy Settings</div>
		</div>
		<Explainer
